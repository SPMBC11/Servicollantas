              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                <div className="absolute bottom-0 left-0 right-0 p-4 sm:p-6"> {/* Adjusted padding */}
                  <div className="flex items-center justify-between">
                    ...
                    <button className="bg-white/20 backdrop-blur-sm p-1.5 sm:p-2 rounded-full text-white hover:bg-white hover:text-gray-900 transition-colors"> {/* Adjusted padding */}
